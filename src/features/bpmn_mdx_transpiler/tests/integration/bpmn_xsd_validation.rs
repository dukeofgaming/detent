...
fn when_validate_xsd(world: &mut ConvertWorld) {
    ...
    match detent::features::bpmn_mdx_transpiler::infrastructure::validate_bpmn_xsd(xml) {
...
fn when_validate_invalid_element(world: &mut ConvertWorld, name: String) {
    ...
    world.e2e_last_success =
        detent::features::bpmn_mdx_transpiler::infrastructure::validate_bpmn_xsd(&invalid).is_ok();
}
