...
use detent::features::bpmn_mdx_transpiler::adapters::bpmn::{SequenceFlow, StartEvent, Task};
use detent::features::bpmn_mdx_transpiler::adapters::mdx::MdxFile;
...
fn given_mdx_file(world: &mut ConvertWorld, filename: String) {
    ...
    world.mdx_inputs = vec![detent::features::bpmn_mdx_transpiler::application::compile::MdxInput {
...
fn given_all_mdx(world: &mut ConvertWorld) {
    ...
    for name in [
        ...
        world.mdx_inputs.push(
            detent::features::bpmn_mdx_transpiler::application::compile::MdxInput {
