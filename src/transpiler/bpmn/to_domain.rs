//! Conversion from BPMN adapter types to domain types.
//!
//! Per Clean Architecture (ADR-7), adapters depend on the domain layer.
//! These conversions live in the adapter layer where they belong.

use detent_core::bpmn as domain_bpmn;

use super::Process;

/// Convert a BPMN adapter [`Process`] to a domain [`domain_bpmn::Process`]
/// for graph operations in the domain layer.
