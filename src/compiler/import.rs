...
use crate::compiler::bpmn::Definitions;
...
/// Convert BPMN Definitions (IR) into a list of MDX file outputs.
///
/// Each flow element becomes one MDX file with YAML frontmatter.
...
/// Convert a single BPMN element into an MdxOutput
fn to_mdx_output<T: Serialize>(
    id: &str,
    bpmn_type: &str,
    data: &T,
